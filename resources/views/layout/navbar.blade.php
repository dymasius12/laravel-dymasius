        ...
        <div class="flex -mx-4 items-center justify-between relative">
            <div class="pr-4 w-60 max-w-full">
                <a href="/" class="w-full flex items-center py-2">
                    ...
                    <span class="text-xl xl:text-2xl font-bold text-[#204DE3] dark:text-white">Dymasius</span>
                </a>
            </div>
                ...
                <nav :class="!navbarOpen && 'hidden' " id="navbarCollapse"
                    ...
                    <ul class="block lg:flex lg:items-center text-white">
                        ...
                        <div class="ml-0 lg:ml-10 xl:ml-16 relative top-1">
                            <div class="g-ytsubscribe" data-channelid="UCZfKaxxa5uV2WIIZs6xIaWQ" data-layout="default"
